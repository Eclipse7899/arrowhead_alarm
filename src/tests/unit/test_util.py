...
def test_version_parsing():
    version_output = """ECi _F/W Ver. 10.3.52 (WR5SPLS1)"""
...
def test_version_comparison():
    v1 = parse_panel_version_string("ECi _F/W Ver. 10.3.52 (WR5SPLS1)")
    v2 = parse_panel_version_string("ECi _F/W Ver. 10.4.0 (WR5SPLS1)")
    v3 = parse_panel_version_string("ECi _F/W Ver. 11.0.0 (WR5SPLS1)")
...
def test_version_equality():
    v1 = parse_panel_version_string("ECi _F/W Ver. 10.3.52 (WR5SPLS1)")
    v2 = parse_panel_version_string("ECi _F/W Ver. 10.3.52 (W4RXPY2A)")
    assert isinstance(v1, Success)
    assert isinstance(v2, Success)
    assert v1.value.firmware_version == v2.value.firmware_version
...
def test_version_inequality():
    v1 = parse_panel_version_string("ECi _F/W Ver. 10.3.52 (WR5SPLS1)")
    v2 = parse_panel_version_string("ECi _F/W Ver. 10.3.53 (WR5SPLS1)")
    assert isinstance(v1, Success)
    assert isinstance(v2, Success)
    assert v1.value.firmware_version != v2.value.firmware_version
